-- Re-apply (20260430490000): 로컬/원격 DB에 예전 함수가 남아 `column p.place_url does not exist`(42703) 나는 경우를 대비해
-- 800 과 동일 본문으로 한 번 더 CREATE OR REPLACE. 적용 후 Node 서버 재시작 불필요(Postgres만 갱신).
