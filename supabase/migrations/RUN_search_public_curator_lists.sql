-- 맛집첩 검색 RPC — Supabase SQL Editor 에서 실행
-- (= 20260719150000_search_public_curator_lists.sql)
-- 선행: curator_lists / curator_list_places
...
SELECT proname FROM pg_proc WHERE proname = 'search_public_curator_lists';
