-- 맛집첩 좋아요·스크랩 — Supabase Dashboard → SQL Editor 에서 한 번에 실행
-- (= 20260719140000_curator_list_likes_and_scraps.sql)
-- 선행: curator_lists 테이블 (RUN_curator_lists.sql)
...
SELECT
  to_regclass('public.curator_list_likes') AS curator_list_likes,
  to_regclass('public.curator_list_scraps') AS curator_list_scraps;
