-- Idempotent redeploy: curator_id / user_follows.curator_id 가 text·uuid 혼재할 때
-- "operator does not exist: text = uuid" (42883) 방지 — btrim(…::text) 비교
-- (본문은 20260430200000 과 동일 시점 유지)
