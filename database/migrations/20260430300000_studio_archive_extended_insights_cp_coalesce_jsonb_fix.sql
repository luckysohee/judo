-- Follow-up for DBs that already applied 20260430200000 (idempotent CREATE OR REPLACE).
-- Same body as 302000 after fix: COALESCE(cp.*, '[]'::jsonb) breaks when cp columns are text[].
