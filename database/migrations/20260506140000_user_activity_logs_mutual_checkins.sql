-- 맞픽(서로 pick) 유저의 최근 체크인 한 줄 노출용
-- Mirror of supabase/migrations/20260506140000_user_activity_logs_mutual_checkins.sql
-- get_mutual_checkins RPC는 20260507120000 에만 두어 OR REPLACE 충돌을 막음.
