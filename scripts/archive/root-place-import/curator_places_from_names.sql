...
SELECT '만리199', '서울 중구 만리동1가 62-19', 37.55546555457986, 126.96771163328161, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '만리199');

-- 2. L7 강남 플로팅바 (카카오 ID: 1975224967)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT 'L7 강남 플로팅바', '서울 강남구 삼성동 142-41', 37.5057161987885, 127.051629346313, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = 'L7 강남 플로팅바');

-- 3. 히든아워 (카카오 ID: 1594335650)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '히든아워', '서울 종로구 종로5가 395-8', 37.5700931356741, 127.001313067983, NOW()
...
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '추억의길가포장마차', '경기 고양시 일산서구 덕이동 309-3', 37.700143506462034, 126.75975222732384, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '추억의길가포장마차');

-- 37. 청화가든 (카카오 ID: 15381112)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '청화가든', '서울 강북구 수유동 598', 37.6456933045111, 127.004219669737, NOW()
...
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '아노브피자 이태원', '서울 용산구 이태원동 74-34', 37.533725009249764, 126.99242524178638, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '아노브피자 이태원');

-- 108. 싱싱소한마리 (카카오 ID: 1339849959)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '싱싱소한마리', '서울 성북구 동소문동2가 153', 37.5885397542294, 127.00895597453, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '싱싱소한마리');

-- 109. 신천포차 (카카오 ID: 7980341)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '신천포차', '서울 송파구 잠실동 208-6', 37.5092806690364, 127.085592288053, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '신천포차');

-- 110. 신진슈퍼 (카카오 ID: 920440071)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '신진슈퍼', '서울 종로구 종로5가 225-10', 37.570374169805, 127.004446336564, NOW()
...
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '무채색', '서울 마포구 동교동 113-24', 37.56058144382453, 126.92581091027769, NOW()
...
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '명동골뱅이', '서울 중구 을지로3가 95-6', 37.5669501781499, 126.991696325885, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '명동골뱅이');

-- 150. 메종드쌍문 (카카오 ID: 90926338)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '메종드쌍문', '서울 도봉구 쌍문동 628', 37.6571933823998, 127.039011898396, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '메종드쌍문');

-- 151. 메이게츠 군자 (카카오 ID: 1536072723)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '메이게츠 군자', '서울 광진구 군자동 476-10', 37.5558894478948, 127.077773185523, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '메이게츠 군자');

-- 152. 멍석집 (카카오 ID: 10351528)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '멍석집', '충북 괴산군 칠성면 두천리 139-3', 36.7911773731357, 127.839635394283, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '멍석집');

-- 153. 먹거리장터2 (카카오 ID: 16704633)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '먹거리장터2', '서울 성동구 행당동 293-2', 37.55980263036762, 127.03345599158146, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '먹거리장터2');

-- 154. 먹거리장터 (카카오 ID: 16653451)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '먹거리장터', '대전 대덕구 목상동 156-3', 36.44721291932103, 127.4122546842708, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '먹거리장터');

-- 155. 매일호프 (카카오 ID: 18567499)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '매일호프', '서울 중구 을지로2가 101-27', 37.566676055503606, 126.98900582182826, NOW()
...
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '루프808', '서울 강남구 역삼동 808', 37.504339079125394, 127.02505080057104, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '루프808');

-- 168. 랜돌프비어 마곡나루 (카카오 ID: 1272392964)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '랜돌프비어 마곡나루', '서울 강서구 마곡동 738-3', 37.568313468085684, 126.82483191401953, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '랜돌프비어 마곡나루');

-- 169. 뚝도지기 (카카오 ID: 38620260)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '뚝도지기', '서울 성동구 성수동2가 335-36', 37.5378040702262, 127.05460798425395, NOW()
...
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '디자이너리카페', '서울 관악구 신림동 1465-12', 37.485044830857, 126.92412069161948, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '디자이너리카페');

-- 173. 동해남부선 서촌본점 (카카오 ID: 21056157)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '동해남부선 서촌본점', '서울 종로구 내자동 11-1', 37.576395762477766, 126.97148477885403, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '동해남부선 서촌본점');

-- 174. 동해골뱅이 (카카오 ID: 524675225)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '동해골뱅이', '인천 남동구 논현동 624-4', 37.4024736243132, 126.72246345802, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '동해골뱅이');

-- 175. 동백상회 (카카오 ID: 340372135)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '동백상회', '서울 마포구 동교동 149-2', 37.56062034503681, 126.924638314908, NOW()
...
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '낙성아주', '서울 관악구 봉천동 1620-33', 37.4778518930148, 126.958096837209, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '낙성아주');

-- 203. 낙산공원 (카카오 ID: 8253524)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '낙산공원', '서울 종로구 동숭동 산 2-10', 37.58056966858, 127.007521763748, NOW()
WHERE NOT EXISTS (SELECT 1 FROM places WHERE name = '낙산공원');

-- 204. 나누리잡화점 (카카오 ID: 165787715)
INSERT INTO places (name, address, lat, lng, created_at) 
SELECT '나누리잡화점', '서울 성동구 성수동2가 315-55', 37.542863137107425, 127.05471011825232, NOW()
