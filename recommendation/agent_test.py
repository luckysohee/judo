...
def save_place_import_tmp(_supabase: Any = None, **kwargs: Any) -> Any:
    from recommendation.save_place_import_tmp import save_place_import_tmp as _impl

    return _impl(**kwargs)


def save_db(_supabase: Any = None, **kwargs: Any) -> Any:
    from recommendation.save_place_import_tmp import save_db as _impl

    return _impl(**kwargs)


def save_to_db(_supabase: Any = None, **kwargs: Any) -> Any:
