...
const styles = {
  ...
  peekThumb: {
    ...
    display: "block",
    background:
      "linear-gradient(135deg, rgba(99,102,241,0.22), rgba(226,232,240,0.75))",
  },
  peekTitle: {
    margin: 0,
    fontSize: 11,
  ...
  tabBtn: (active) => ({
    ...
    padding: "6px 4px",
    borderRadius: 999,
    border: active ? "none" : "1px solid rgba(99,102,241,0.22)",
    background: active ? "rgba(99,102,241,0.16)" : "rgba(255,255,255,0.6)",
    fontSize: 10,
    fontWeight: 800,
    letterSpacing: "-0.02em",
    color: active ? "#4338ca" : "rgba(51,65,85,0.72)",
    cursor: "pointer",
    lineHeight: 1.25,
  }),
  singleList: {
