...
function buildRegionKeywords() {
  const LEGACY = {
    ...
    홍대: ["홍대", "홍대입구", "합정", "상수", "망원", "연남", "연남동", "서교동"],
    성수: ["성수", "성수역", "성수동", "성수로"],
    /** 성수 인접 — 근처 지역 코스·검색용 독립 클러스터 */
    서울숲: ["서울숲", "서울숲역", "서울숲길", "서울숲2길", "서울숲공원"],
    뚝섬: ["뚝섬", "뚝섬역", "뚝섬로", "뚝섬한강공원"],
    건대: ["건대", "건대입구", "건대역", "건대입구역", "구의동", "자양동"],
    을지로: ["을지로", "을지로입구", "을지로3가", "을지로4가", "을지로5가", "동대문"],
    종로: ["종로", "종로3가", "종로5가", "광화문", "시청", "서울역"],
    /** 충무로는 명동·다동(시청)과 분리 — 노포 코스가 무교·다동으로 새지 않게 */
    충무로: ["충무로", "충무로역", "필동", "인현동", "예장동", "초동"],
    명동: ["명동", "명동입구", "회현"],
    신촌: ["신촌", "이대", "아현", "공덕"],
    /** 문정·가락 — 잠실(석촌·롯데)과 분리 */
