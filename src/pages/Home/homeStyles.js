...
export const styles = {
  ...
  courseAddHalfStepFloatingBtn: {
    ...
    background: "rgba(255, 192, 213, 0.42)",
    ...
    gap: 6,
    boxShadow:
      "0 4px 18px rgba(236,72,153,0.22), inset 0 1px 0 rgba(255,255,255,0.85)",
    WebkitTapHighlightColor: "transparent",
  },
  /** 지도에 코스 루트가 떠 있을 때 「내 코스로 저장」 — 쩜오 추가 버튼 위에 쌓음 */
  courseSaveToMyFloatingBtn: {
    position: "absolute",
    right: "14px",
    bottom: `calc(${homeCourseHalfStepFloatingBtnBottomCss()} + 52px)`,
    zIndex: 261,
    pointerEvents: "auto",
    width: "150px",
    boxSizing: "border-box",
